...
[![Status](https://img.shields.io/badge/status-Phase%203.7-brightgreen)](#ロードマップ)
...
│  │    spawn_agent / notify / pins / notes / inbox  │ │
...
- `cargo check` + `cargo test`(PTY/session・Git・worktree・state・resource・Queen、56 tests): 合格
...
- [x] **Phase 3.0–3.7** — Git diff/commit・worktree分離・logical resume・リソース監視・Queen pins/notes/inbox/reply(17 tools)

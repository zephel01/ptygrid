...
[![Status](https://img.shields.io/badge/status-Phase%203.8-brightgreen)](#ロードマップ)
...
- `cargo check` + `cargo test`(PTY/session・Git・worktree・state・resource・Queen、57 tests): 合格

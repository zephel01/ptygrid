...
";
    ...
    fn detect_reply_completions_completes_a_reply_joined_step() {
        ...
        assert!(
            !detect_reply_completions(&store, &dir, &view, &wf, &mut run),
        ...
        assert!(detect_reply_completions(&store, &dir, &view, &wf, &mut run));
        assert_eq!(
            run.steps[0].state,
            StepState::Succeeded,
